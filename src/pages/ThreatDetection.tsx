    ...
    <div className="min-h-screen bg-cyber-dark text-cyber-text">
      ...
      <div className="container mx-auto px-4 pt-24 pb-20">
        <div className="mb-12 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Threat Detection</h1>
          
          <p className="text-xl text-cyber-muted">
            Proactive monitoring and identification of potential security threats before they become breaches.
          </p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-xl border border-cyber-purple/20 mb-12">
          ...
          <p className="text-cyber-muted">Our advanced threat detection systems use cutting-edge technologies to identify, analyze, and prevent potential security risks in real-time.</p>
        </div>
      </div>
      <Footer />
    </div>
